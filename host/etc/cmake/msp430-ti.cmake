...
MACRO (use_target target)
  ...
  SET (XCC_MAX_OPTIMIZATION_LEVEL "3")
...
MACRO (use_default_xcc_settings)
  ...
  SET (CMAKE_C_FLAGS "${ARCH} -g ${XCC_FEAT_DEFS} ${XCC_WARN_DEFS} ${EXTRA_DEFS}")
...
MACRO (use_default_xxx_settings)
  ...
  SET (CMAKE_CXX_FLAGS "${ARCH} -g ${GXX_FEAT_DEFS} ${GXX_WARN_DEFS} ${EXTRA_DEFS}")
